...
public class BackgroundDestructibleTile extends Tile {
	public boolean isCurrentlyDestructible;
	public double baseDurability;
	public double hardness;
	public double durability;
	
	public BackgroundDestructibleTile(int id, int levelColour, String name, boolean startsDestructible, double hardness, double durability) {
